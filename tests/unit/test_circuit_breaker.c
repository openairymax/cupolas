...
static void test_breaker_create_destroy(void)
{
    ...
    circuit_breaker_config_t config = {.failure_threshold = 3,
                                       .success_threshold = 2,
                                       .timeout_ms = 1000,
...
static void test_breaker_half_open_recovery(void)
{
    ...
    circuit_breaker_config_t config = {.failure_threshold = 2,
                                       .success_threshold = 2,
                                       .timeout_ms = 100,
...
static void test_breaker_reject_when_open(void)
{
    ...
    circuit_breaker_config_t config = {.failure_threshold = 1,
                                       .success_threshold = 2,
                                       .timeout_ms = 1000,
                                       .half_open_max_calls = 2,
                                       .failure_rate_threshold = 0.5};
